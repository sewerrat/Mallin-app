    ...
    return (
      <View style={styles.container}>
        <View style={styles.frame}>
          <Animated.Image
            source={require('mallin-app/assets/chatheads-delete.png')}
        ...
        <View style={styles.frame} pointerEvents='box-none'>
          <Interactable.View
            ...
            <Animated.View style={[styles.head, {
              ...
              <Image style={styles.image} source={require('mallin-app/assets/chatheads-face1.jpg')} />
            </Animated.View>
          </Interactable.View>
        </View>
        ...
        <View style={styles.frame} pointerEvents='box-none'>
          <Interactable.View
            ...
            <Animated.View style={[styles.head, {
              ...
              <Image style={styles.image} source={require('mallin-app/assets/chatheads-face2.jpg')} />
            </Animated.View>
          </Interactable.View>
        </View>
      }
