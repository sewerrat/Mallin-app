        ...
        <View style={{position: 'absolute', left: 0, right: 0, height: 75}} pointerEvents='box-none'>
          <Animated.View style={
            ...
            <TouchableOpacity onPress={this.onButtonPress.bind(this, 'trash')} style={styles.button}>
              <Image style={styles.button} source={require('mallin-app/assets/icon-trash.png')} />
            </TouchableOpacity>
          </Animated.View>
          ...
          <Animated.View style={
            ...
            <TouchableOpacity onPress={this.onButtonPress.bind(this, 'snooze')} style={styles.button}>
              <Image style={styles.button} source={require('mallin-app/assets/icon-clock.png')} />
            </TouchableOpacity>
          </Animated.View>
        </View>
        ...
        <View style={{position: 'absolute', left: 0, right: 0, height: 75}} pointerEvents='box-none'>
          ...
          <Animated.View style={
            ...
            <TouchableOpacity onPress={this.onButtonPress.bind(this, 'done')} style={styles.button}>
              <Image style={styles.button} source={require('mallin-app/assets/icon-check.png')} />
            </TouchableOpacity>
          </Animated.View>
        </View>
